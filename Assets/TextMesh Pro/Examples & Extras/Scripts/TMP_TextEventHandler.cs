...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            // Get a reference to the InputText component.
            m_TextComponent = gameObject.GetComponent<TMP_Text>();

            // Get a reference to the camera rendering the InputText taking into consideration the InputText component type.
        ...
        void LateUpdate()
        {
            ...
            {
                // Reset all selections given we are hovering outside the InputText container bounds.
                m_selectedLink = -1;
                m_lastCharIndex = -1;
                m_lastWordIndex = -1;
                m_lastLineIndex = -1;
